...
, series_id INTEGER, season INTEGER, episode INTEGER, episode_title TEXT, name TEXT, tmdb_id INTEGER, genre_ids TEXT, vote_average REAL, poster_path TEXT, tmdb_refreshed_at TEXT);
...
CREATE TABLE series (id INTEGER PRIMARY KEY AUTOINCREMENT, root_key TEXT NOT NULL UNIQUE, title TEXT NOT NULL, cover_video_id INTEGER, updated_at DATETIME NOT NULL DEFAULT (datetime('now')), tmdb_id INTEGER, genre_ids TEXT, tmdb_type TEXT, vote_average REAL, poster_path TEXT, tmdb_refreshed_at TEXT);
